<?php
    ...
    session_start();
		...
		$student_roll_number = $_GET['rollNumber'];
    $student_password = $_GET['password'];
		
		//echo "select id from student_data where rollno = '$student_roll_number'";
    ...
    $student_id = $row1["id"];
		...
		//echo "Select id, test_id, rollno, score, status from students where rollno = '".$student_id."' and password = '".$student_password."' and status = 0 ";
